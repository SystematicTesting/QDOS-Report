...
<div id="version-history" class="row grey-background show-box">
  ...
  <c3chart bindto-id="versionHistoryGraph" chart-data="graphData.datapoints" chart-columns="graphData.datacolumns" chart-x="graphData.datax" show-labels="true" show-subchart="false" enable-zoom="true">
	  ...
	  <chart-axis>
		...
		<chart-axis-y axis-id="y" axis-position="outer-right" axis-label="Test Cases & Test Suites" padding-top="50" padding-bottom="1"/>
	  </chart-axis>
			...
			<div class="col-md-6">
				<div class="row">
					<div class="col-xs-6 show-dark-box">
						<h6><span class="">Version</span></h6>
					</div>
					<div class="col-xs-6 show-dark-box">
						<h6><span class="">Time created</span></h6>
					</div>
				</div>
			</div>
			<div class="col-md-6">
				<div class="row">
					<div class="col-xs-6 show-dark-box">
						<h6><span class="">Test Suites Count</span></h6>
					</div>
					<div class="col-xs-6 show-dark-box">
						<h6><span class="">Test Cases Count</span></h6>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row show-box version-row-data highlight-box" ng-repeat="item in tableData | reverse | filter:searchQuery as results">
			<a href="{{moduleAccessURL}}/{{email | encodeURI}}/{{siteName | encodeURI}}/version/{{item.versionNumber}}">
				...
				<div class="col-md-6">
					<div class="row">
						<div class="col-xs-6">
							<span class="">{{item.totalNumberOfSuites}}</span>
						</div>
						<div class="col-xs-6">
							<span class="">{{item.totalNumberOfTestCases}}</span>
						</div>
					</div>
				</div>
			</a>
